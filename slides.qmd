...
Results that are open access can be seen 'de-silo' transport planning. Skill: web development (or at least collaboration with web developers/AI tools to build web interfaces).

Source: [github.com/robinlovelace/itfworkshop](https://github.com/Robinlovelace/itfworkshop/blob/main/create_flowmap.R)

<iframe src="files/basic_flowmap.html" width="100%" height="500px" style="border: none;"></iframe>
...
## Links {background-image="images/paste-3.png" background-opacity="0.5"}
...
## Appendix: Animated Map of Ukrainian Refugee Flows
