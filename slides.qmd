...
Spatio-temporal visualisation of real origin-destination data using the `{spanishoddata}` R package and `{mapgl}`. Source: [github.com/robinlovelace/itfworkshop](https://github.com/Robinlovelace/itfworkshop/blob/main/create_flowmap.R)
